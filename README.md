...
- **识别对象**：内容垃圾号和导流号。内容垃圾号通常看回复正文就能判断；导流号往往要查账号主页，所以会慢一些。
- **处理方式**：隐藏和屏蔽。隐藏是本地折叠，马上改善阅读体验；屏蔽会调用 X 的 block 接口，更彻底，但更慢，也更受平台限制。

也就是说，内容垃圾号和导流号都可以隐藏，也都可以屏蔽；只是识别速度和处理成本不一样。
